...
def PLSR():
    ...
    while(True):
        ...
        for n_comp in range(2, min(len(X_train)+1,len(data.axes[0])-num_depen_var+1,30)):
        ...
        print("The number of components for best r2 score was: " + str(best_ncomp))
        ...
        if(len(X_test) != 0):
            ...
            concatanation.to_csv(os.path.join(folderPathway,("PLSR_Predictions_"+fileName)))
            print(concatanation)
        else:
